# PR-U-NET-subseasonal_model_u-tp_best
import os
...
EPOCHS = 1000
LEARNING_RATE = 1e-3
CHECKPOINT_PATH = './subseasonal_model_u-tp.pth'
BEST_MODEL_PATH = './subseasonal_model_u-tp_best.pth'  # 保存loss最小的模型
EPOCH_RECORD_FILE = './checkpoint_epoch22.txt'
NORM_PARAM_FILE = './norm_params_tp22.npz'
...
target_vars = ['tp_mon', 'tp_wed', 'tp_fri', 'tp_sun',
...
for epoch in range(start_epoch, EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        print(f"[Info] 新最佳模型保存于 epoch {epoch+1}，Val Loss={val_loss:.4f}")
